...
import { Upload, X, FileText, ImageIcon, Video, Archive, Loader2 } from "lucide-react"
...
export function UploadForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setSuccess("Ficheiro carregado com sucesso! Aguarda aprovação.")
      toast({
        title: "Sucesso!",
        description: "O teu ficheiro foi carregado e está a aguardar aprovação.",
      })
