...
export function FileDetail({ fileId }: FileDetailProps) {
  ...
  const handleViewResources = () => {
    toast({
      title: "A carregar recursos",
      description: `A mostrar todos os recursos de ${document?.perfis_usuarios?.nome_completo}`,
    })
  }
  ...
  return (
    <div className="space-y-6">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="flex items-center gap-4 text-sm text-muted-foreground">
                ...
                <div className="flex items-center gap-1">
                  ...
                  {document.avaliacao_media || 0} ({document.total_avaliacoes || 0} avaliações)
                </div>
              </div>
            </div>
          </div>
        ...
        <CardContent>
          <div className="flex items-center gap-4">
            ...
            <div className="flex gap-2">
              ...
              <Button variant="outline" size="sm" onClick={handleViewResources}>
                Ver Recursos
              </Button>
            </div>
          </div>
      ...
      <RatingSection
        fileId={fileId}
        currentRating={document.avaliacao_media || 0}
        ratingCount={document.total_avaliacoes || 0}
      />
