...
export default function HomePage() {
  const universidades = [
    { nome: "Universidade de Santiago", sigla: "US", cor: "bg-chart-2", estudantes: "2.6K+", destaque: true },
    { nome: "Universidade de Cabo Verde", sigla: "Uni-CV", cor: "bg-chart-1", estudantes: "3.2K+" },
    { nome: "Universidade Jean Piaget", sigla: "UniPiaget", cor: "bg-chart-3", estudantes: "1.8K+" },
    { nome: "Instituto Superior de Ciências Económicas", sigla: "ISCEE", cor: "bg-chart-4", estudantes: "900+" },
    { nome: "Universidade Lusófona", sigla: "ULCV", cor: "bg-chart-5", estudantes: "1.2K+" },
  ]
  ...
  const conteudosPopulares = [
    {
      ...
      thumbnail: "/algorithms-data-structures-programming.jpg",
    },
    {
      titulo: "Anatomia Humana Básica",
      curso: "Medicina",
      views: "1.3K",
      rating: 4.6,
      cor: "bg-gradient-to-br from-cyan-500 to-blue-600",
      thumbnail: "/human-anatomy-medical-illustration.jpg",
    },
    {
      ...
      thumbnail: "/constitutional-law-legal-books.jpg",
    },
    {
      titulo: "Microeconomia Avançada",
      curso: "Economia",
      views: "1.3K",
      rating: 4.6,
      cor: "bg-gradient-to-br from-pink-500 to-rose-600",
      thumbnail: "/microeconomics-graphs-charts.jpg",
    },
  ]
      ...
      <section className="py-12 px-6">
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {conteudosPopulares.map((conteudo, index) => (
              <Link
                key={index}
                href={`/browse/${index + 1}`}
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center justify-between text-xs">
                    ...
                    <div className="flex items-center gap-1">
                      ...
                      <span className="text-primary">{conteudo.rating}</span>
                    </div>
                  </div>
                </div>
              </Link>
        ...
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
            {universidades.map((uni, index) => (
              <Link key={uni.sigla} href={`/universidade/${uni.sigla.toLowerCase().replace("-", "")}`}>
        ...
        <div className="container mx-auto max-w-5xl">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            <div className="hover:scale-110 transition-all">
              <div className="text-5xl font-serif font-black text-primary mb-4 pulse-neon">2.5K+</div>
              <div className="text-muted-foreground text-lg">Recursos Partilhados</div>
            </div>
            <div className="hover:scale-110 transition-all">
              <div className="text-5xl font-serif font-black text-primary mb-4 pulse-neon">850+</div>
              <div className="text-muted-foreground text-lg">Estudantes Ativos</div>
            </div>
            <div className="hover:scale-110 transition-all">
              <div className="text-5xl font-serif font-black text-accent mb-4 pulse-neon">5</div>
              <div className="text-muted-foreground text-lg">Universidades</div>
            </div>
            <div className="hover:scale-110 transition-all">
              <div className="text-5xl font-serif font-black text-chart-4 mb-4 pulse-neon">50+</div>
